...
namespace EditorAssetBundle
{
    ...
    public class AssetBundleImporter
    {
        ...
        // {
        //     get { return assetImporter; }
        // }

        public string assetBundleName
        {
            get { return IsValid ? assetImporter.assetBundleName : null; }
            set
            {
                if (IsValid)
                {
        ...
        {
            get { return IsValid ? assetImporter.assetBundleVariant : null; }
            set
            {
        ...
        {
            get { return IsValid ? assetImporter.assetPath : null; }
        }

        public string packagePath
        {
            get { return IsValid ? AssetBundleUtility.AssetsPathToPackagePath(assetPath) : null; }
        }

        public ulong assetTimeStamp
        {
            get { return IsValid ? assetImporter.assetTimeStamp : 0L; }
        }

        public string userData
        {
            get { return IsValid ? assetImporter.userData : null; }
            set
            {
                if (IsValid)
                {
        ...
        /// <summary>
        /// 获取此文件下所有的有效的孩子 AssetBundleImporter
        /// </summary>
        /// <returns>孩子集合</returns>
